  ...
  if (category === "ALL") {
    ...
    return (
        <div className='w-full h-auto'>
            <div className='explore-items-wrap relative grid grid-cols-1 gap-8 m-4 sm:m-16 lg:m-[9vw]'>
                {/* categories */}
                        ...
                        <div className='flex-none'>
                            <Link href="/categories">
                                <a className="to-all-link">
                                    See All
                                    <svg className='to-all-icon' width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                      <circle cx="9" cy="9" r="9" fill="#4CEBBB"/>
                                      <path d="M6 13L13 10.2093V7.7907L6 5V7.49834L9.97227 8.90698L6 10.4086V13Z" fill="#0D0C16"/>
                                    </svg>
                                </a>
                            </Link>
                        </div>
